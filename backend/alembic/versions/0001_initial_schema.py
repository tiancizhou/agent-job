...
def upgrade() -> None:
    ...
    op.bulk_insert(
        sa.table(
            ...
            sa.column("created_at", DB_DATETIME),
            sa.column("updated_at", DB_DATETIME),
        ),
    ...
    op.create_table(
        ...
        sa.Column("created_at", DB_DATETIME, nullable=False),
        sa.Column("updated_at", DB_DATETIME, nullable=False),
        sa.Column("expires_at", DB_DATETIME, nullable=False),
        sa.ForeignKeyConstraint(["user_id"], ["users.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.bulk_insert(
        ...
        [{
            "id": "5373d4a3-daf9-41fe-b81e-dfc72eba7446",
            "employee_no": "64003",
            "password_hash": "22a293561aed2b58db20c0932bf1b4fd$d2477a7fa800f4e2da79097dac7bb70e9390c6756bf04d88e2085d98d3dcdf1f",
            "is_admin": True,
            "created_at": datetime(2026, 4, 25, 0, 0, 0),
            "updated_at": datetime(2026, 4, 25, 0, 0, 0),
        }],
